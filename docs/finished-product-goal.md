...
- Local weekly show recaps now route booked match segments through the existing Show Engine shell, which in turn runs the Match Engine shell with seeded deterministic context, while keeping fan/social/business engines and hidden internals out of the player-facing recap.
