...
- Week HQ now derives a local season calendar from the current week, including road-to-special-event timing, title defense window labels, rivalry payoff prompts, and show history counts.
